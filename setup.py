...
setup(
    name='invoice-pdf-generator',  # * Your package will have this name, users will install this
    ...
    author='Fahad Shaikh',
    author_email='fahadshaikh36@outlook.com',
    url='https://github.com/fahadfhs',  # Homepage of your library (e.g. github or your website)
    keywords=['invoice', 'excel', 'pdf', 'converter', 'document converter'],  # Keywords users can search on pypi.org
